'''
O jogo em C# precisa de elementos para funcionar
Lógica desse jogo: terá 10 cards com um lado tendo o mesmo design
Terá 5 pares; cada par terá uma imagem igual
Ojogador pode virar duas cards, se forem iguais: elas permanecem viradas; se não forem iguais: elas viram novamente.
